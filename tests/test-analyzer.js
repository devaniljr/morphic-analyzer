...
function testSimpleLog() {
    ...
    const expected = [
        {
            functionName: 'averageNumberOfWheels',
            file: 'examples/megamorphic-real.js',
            location: '42:31',
            icTransitions: [
                {
                    icType: 'LoadIC',
    ...
    assertEqual(result, expected, 'Simple log file should return the correct summarized analysis');
}
